        ...
        <div className="relative px-8">
            <div className="absolute top-0 right-0 left-0">
                <div className="bg-white py-2 text-white z-20 border-b-2">
                    <div className="flex lg:mx-[110px] px-8">
                ...
                <div className="w-full lg:w-5/6 lg:ms-10">
                    {results.map((result) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className="rounded-lg flex shadow-[0_3px_10px_rgb(0,0,0,0.2)] h-[12rem]"
                                >
                                    <div className="w-1/6">
                                        <img
                                            style={{
                                    ...
                                    <div className="w-full px-2 py-3 text-left">
                                        ...
                                        <p className="mt-4 text-sm">{result.overview}</p>
                                    </div>
                                </div>
                            </Link>
                        );
